...
public class ModCrossbowItems extends RangedWeaponItem {
    ...
    private static final net.minecraft.item.CrossbowItem.LoadingSounds DEFAULT_LOADING_SOUNDS = new net.minecraft.item.CrossbowItem.LoadingSounds(
    ...
    public ModCrossbowItems(Item.Settings settings) {
        super(settings);
    }
    ...
    net.minecraft.item.CrossbowItem.LoadingSounds getLoadingSounds(ItemStack stack) {
        return (net.minecraft.item.CrossbowItem.LoadingSounds)EnchantmentHelper.getEffect(stack, EnchantmentEffectComponentTypes.CROSSBOW_CHARGING_SOUNDS)
    ...
    public static record LoadingSounds(Optional<RegistryEntry<SoundEvent>> start, Optional<RegistryEntry<SoundEvent>> mid, Optional<RegistryEntry<SoundEvent>> end) {
        public static final Codec<net.minecraft.item.CrossbowItem.LoadingSounds> CODEC = RecordCodecBuilder.create(
                instance -> instance.group(
                                SoundEvent.ENTRY_CODEC.optionalFieldOf("start").forGetter(net.minecraft.item.CrossbowItem.LoadingSounds::start),
                                SoundEvent.ENTRY_CODEC.optionalFieldOf("mid").forGetter(net.minecraft.item.CrossbowItem.LoadingSounds::mid),
                                SoundEvent.ENTRY_CODEC.optionalFieldOf("end").forGetter(net.minecraft.item.CrossbowItem.LoadingSounds::end)
                        )
                        .apply(instance, net.minecraft.item.CrossbowItem.LoadingSounds::new)
        );
    }
}
